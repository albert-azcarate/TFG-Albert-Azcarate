...
add wave -noupdate -label {Respuesta Procesador 1} -radix hexadecimal -childformat {{/prueba_ensamblado_multi/respuestas(1).DL -radix hexadecimal} {/prueba_ensamblado_multi/respuestas(1).BL -radix hexadecimal} {/prueba_ensamblado_multi/respuestas(1).dir_rec -radix hexadecimal} {/prueba_ensamblado_multi/respuestas(1).val -radix hexadecimal}} -subitemconfig {/prueba_ensamblado_multi/respuestas(1).DL {-radix hexadecimal} /prueba_ensamblado_multi/respuestas(1).BL {-radix hexadecimal} /prueba_ensamblado_multi/respuestas(1).dir_rec {-radix hexadecimal} /prueba_ensamblado_multi/respuestas(1).val {-radix hexadecimal}} /prueba_ensamblado_multi/respuestas(1)
add wave -noupdate -divider Campos
...
add wave -noupdate -height 16 -label Dirección -radix unsigned /prueba_ensamblado_multi/ensa_ca_mem/proc_multi(1)/cache/cach/obs_bus.dir
add wave -noupdate -height 16 -label Petición -radix unsigned /prueba_ensamblado_multi/ensa_ca_mem/proc_multi(1)/cache/cach/obs_bus.pet
add wave -noupdate -height 16 -label Pt/PtIm -radix unsigned /prueba_ensamblado_multi/ensa_ca_mem/proc_multi(1)/cache/cach/obs_bus.esc
...
add wave -noupdate -label {Bloqueo del bus} /prueba_ensamblado_multi/ensa_ca_mem/proc_multi(1)/cache/cach/cache_sin/s_control_obs.bloq_bus
...
WaveRestoreCursors {{P0 y P1 inicio petición} {803000 ps} 1} {{Peticiones de concesión} {922000 ps} 1} {{Concesión de Bus a P1} {1002000 ps} 1} {{Escritura de P1; Concesión P0} {1722000 ps} 1} {{Observación Pt y suministro} {1962000 ps} 1} {{Lectura del Dato P0} {2363000 ps} 1}
...
update
WaveRestoreZoom {704653 ps} {2976849 ps}
